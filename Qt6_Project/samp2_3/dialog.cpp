...
void Dialog::do_chkBoxUnder(bool chcked)
{
    QFont font=txtEdit->font();
    font.setUnderline(chcked);
    txtEdit->setFont(font);
}

void Dialog::do_chkBoxItalic(bool chcked)
{
    QFont font=txtEdit->font();
    font.setItalic(chcked);
    txtEdit->setFont(font);
}

void Dialog::do_chkBoxBold(bool chcked)
{
    QFont font=txtEdit->font();
    font.setBold(chcked);
    txtEdit->setFont(font);
