...
Q_CONSTINIT static const qt_meta_stringdata_Teacher_t qt_meta_stringdata_Teacher = {
    {
        ...
        QT_MOC_LITERAL(8, 2),  // "el"
        QT_MOC_LITERAL(11, 0),  // ""
        QT_MOC_LITERAL(12, 8)   // "foodNmae"
    },
    "Teacher",
    "el",
    "",
...
void Teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->el(); break;
        case 1: _t->el((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Teacher::el; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
